    ...
    return (
        <div className="textInputContainer">
            ...
            {textField ?
                ...
                />}
            {password ?
                <span className="textInputEyeWrapper" onClick={() => setShowPassword(!showPassword)}>
                    <FontAwesomeIcon style={{position: 'absolute'}} color="var(--primary-text)" size="1x" icon={Icon[showPassword ? 'faEyeSlash' : 'faEye']} transform={{ rotate: 0 }} />
                </span>
                : null}
        </div>
    );
