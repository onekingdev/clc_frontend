    ...
    if (rightCard.current != null && rightCard.current != null) {
      if (me) {
        (leftCard.current as HTMLImageElement).style.transform =
          "rotate(-10deg)";
        (rightCard.current as HTMLImageElement).style.transform =
          "rotate(10deg)";
        (container.current as HTMLDivElement).style.transform =
          "translateY(10px)";
  ...
  return (
    <div className="pokerPlayerItemsWrapper" ref={container}>
      <div>
        ...
        <div
          className="pokerPlayerItemsWrapper"
          style={
            turn
              ? {
                  width: 94,
        ...
        >
          ...
          >
            <div
              style={
                mp > 999999 ? { transform: "scale(.9)" } : { marginRight: 9 }
              }
            >
              <SmallText
                color={dealer === player ? "#000" : "#FFF"}
              >{`${UTGLabels[index]}`}</SmallText>
            </div>
        ...
        {dealer === player && player < 5 ? (
          <img
            ...
            width={16}
            height={16}
            className="dealerChipBottomLeft"
          />
          ...
          <img
            ...
            width={16}
            height={16}
            className="dealerChipBottomRight"
          />
        ) : (
          <img
            src={dealer_chip}
