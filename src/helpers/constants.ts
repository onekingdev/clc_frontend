...
export const apiStagingHostUrl = 'https://us-central1-staging-clc.cloudfunctions.net';
...
export const resetPasswordEmailSent = 'We sent you a email to reset your password!';
