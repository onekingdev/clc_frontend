...
export const setProgressData = (data: {
  id: number;
...
export const fetchQuestionProgressbar =
  (type: string, dailyQuestions?: number, UID?: string) =>
  async (dispatch: (data: any) => void, getState: any) => {
    ...
    fetch(
        `${process.env.REACT_APP_CONVERTKIT_API_URL}forms/${process.env.REACT_APP_CONVERTKIT_FORM_ID}/subscribe`,
        {
        method: "POST",
        headers: {
