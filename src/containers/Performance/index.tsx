...
function Performance(props: any) {
  ...
  return (
    <ScreenTemplate>
      <Banner
        topText="Track your progress"
        title="My Performance"
        footerValues={[
          props.tableData.myCorrectQuestions,
          props.tableData.myChipsEarned,
          props.tableData.myTickets,
        ]}
      />
      ...
      <div style={{ marginTop: 72 }}>
        <TabNavigation
          selectedIndex={tab}
          tabs={["This Season", "This Week", "This Month", "Lifetime"]}
